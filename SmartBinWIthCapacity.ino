...
void loop()
{
  ...
  if (now - lastSensorRead >= SENSOR_READ_INTERVAL)
  {
    ...
    int capacity = 0;
    if (distance2 != 999 && distance2 <= BIN_LENGTH_CM)
      capacity = (int)((1.0 - distance2 / BIN_LENGTH_CM) * 100.0);
